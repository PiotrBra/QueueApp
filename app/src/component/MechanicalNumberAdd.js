...
const MechanicalNumberAdd = ({ onNumberAdded }) => { // Przekazujemy funkcję onNumberAdded jako props
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await axios.post('http://localhost:8080/mechanicalinspection/numbers', null, {
                params: { carName }
            });
...
export default MechanicalNumberAdd;
